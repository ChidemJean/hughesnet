<a href="tel:{{ $geral_inf->phone }}" class="group flex flex-row px-2 sm:px-3 py-2 border-2 rounded-md border-white/20  @if(isset($drawer) and $drawer === true) @else scale-90 @endif">

        ...
        <AuthenticatedLayout
            ...
            header={
                <div className='w-full flex items-center justify-between'>
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Criar banner</h2>
                    <div className="flex items-center">
                        ...
                        <PrimaryButton onClick={e => { document.forms['store_banner'].requestSubmit() }}>
